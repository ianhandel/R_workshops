...
2. In RStudio File > New Project to set it up as a project
3. On shared machines Session > Set working directory > To Project...
4. Copy aliendata_20180331.xlsx into the folder
5. Start a new Rmd file...
