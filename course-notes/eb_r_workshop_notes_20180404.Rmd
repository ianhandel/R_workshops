...
These notes are based on a ficitious data (mydata) so the R code won't run - but the code shows you examples you can modify to suit your datasets and variables.
...
library(readxl) # this reads Excel!
```
...
To count / tally the number of obervations of each breed...
...
To count animals in each breed by region
